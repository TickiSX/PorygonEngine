...
protected:
    bool m_isActive = true; ///< Indica si la entidad está activa en la escena.
    int  m_id = -1;         ///< Identificador único de la entidad.

    /// Lista de componentes adjuntos a esta entidad.
