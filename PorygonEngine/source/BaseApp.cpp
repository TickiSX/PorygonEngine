...
BaseApp::awake() {
	...
	// Inicializacion de elementos del grafo de escena
	m_sceneGraph.init();
...
BaseApp::init() {
	...
	Layout.push_back({ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0 });
	Layout.push_back({ "NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 20, D3D11_INPUT_PER_VERTEX_DATA, 0 });
